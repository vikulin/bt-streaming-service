...
public class StreamingFileSystemStorageUnit implements StorageUnit {

    private static final Logger LOGGER = LoggerFactory.getLogger(StreamingFileSystemStorageUnit.class);
    ...
    StreamingFileSystemStorageUnit(Path root, String path, long capacity) {
