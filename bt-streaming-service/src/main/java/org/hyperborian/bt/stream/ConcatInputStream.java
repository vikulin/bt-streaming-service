...
public class ConcatInputStream extends InputStream {
   ...
   * @since ostermillerutils 1.04.01
   */
  private ArrayList<ByteBuffer> inputStreamQueue = new ArrayList<ByteBuffer>();
   ...
   * @since ostermillerutils 1.04.01
   */
  private ByteBuffer currentInputStream = null;
   ...
   * @since ostermillerutils 1.04.01
   */
  public void addInputStream(ByteBuffer in){
   ...
   * @since ostermillerutils 1.04.01
   */
  public void addInputStreams(ByteBuffer[] in){
    for (ByteBuffer element: in) {
   ...
   * @since ostermillerutils 1.04.01
   */
  private ByteBuffer getCurrentInputStream(){
   ...
   * @since ostermillerutils 1.04.01
   */
  public ConcatInputStream(long capacity, int bufferSize){
   ...
   * @since ostermillerutils 1.04.00
   */
  public ConcatInputStream(ByteBuffer in){
    addInputStream(in);
   ...
   * @since ostermillerutils 1.04.00
   */
  public ConcatInputStream(ByteBuffer in1, ByteBuffer in2){
    addInputStream(in1);
    addInputStream(in2);
    lastInputStreamAdded();
  }
  ...
  public int read() throws IOException {
    ...
    int r = -1;
    while (r == -1){
      ByteBuffer in = getCurrentInputStream();
      if (in == null){
